...
public class RunEvExample2 {
	...
	public static void main(String[] args) throws IOException {
		...
		new RunEvExample2().run(configUrl);
	}
	...
	public void run(URL configUrl) {
		...
		// TODO: add variable to be tracked in within-day planning -mjw
		
		controler.addOverridingModule(new EvModule());
		controler.addOverridingModule(new AbstractModule() {
			@Override
			public void install() {
				addRoutingModuleBinding(TransportMode.car).toProvider(new EvNetworkRoutingProvider(TransportMode.car)); // TODO: replace with algo -mjw
