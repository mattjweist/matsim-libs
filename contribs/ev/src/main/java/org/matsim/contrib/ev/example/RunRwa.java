...
public class RunRwa {
	static final String DEFAULT_CONFIG_FILE = "test/input/org/matsim/contrib/ev/example/rwa/config.xml";
	private static final Logger log = Logger.getLogger(RunRwa.class);
	...
	public void run(URL configUrl) {
		...
		controler.addOverridingModule(new AbstractModule() {
			...
			public void install() {
				...
				addRoutingModuleBinding(TransportMode.car).toProvider(new EvNetworkRoutingProviderRwa(TransportMode.car));
